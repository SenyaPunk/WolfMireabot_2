...
# Веса символов для барабанов (сумма весов = 64).
# Рассчитаны под вероятности выпадения триплетов (вес/64)^3:
# 7️⃣ (вес 4):  (4/64)^3  = 1/4096 (0.0244%) — x100
# 🐺 (вес 5):  (5/64)^3  = 1/2097 (0.0477%) — x50
# 💰 (вес 6):  (6/64)^3  = 1/1213 (0.0824%) — x25
# 🏆 (вес 8):  (8/64)^3  = 1/512  (0.1953%) — x15
# 🪙 (вес 9):  (9/64)^3  = 1/360  (0.2781%) — x10
# 🎲 (вес 10): (10/64)^3 = 1/262  (0.3815%) — x8
# 🔥 (вес 12): (12/64)^3 = 1/151  (0.6592%) — x5
# 🐾 (вес 10): (10/64)^3 = 1/262  (0.3815%) — x3
SYMBOL_WEIGHTS = [4, 5, 6, 8, 9, 10, 12, 10]
