...
async def main():
    ...
    # Запуск фонового мониторинга жизненного цикла игр, порки рабов, СВО и микрозаймов
    ...
    from utils.loan_monitor import loan_monitor
    asyncio.create_task(loan_monitor(bot))
    ...
    commands = [
        ...
        BotCommand(command="upgrades", description="Улучшения и военные технологии"),
        BotCommand(command="drone", description="Запуск боевого ударного дрона"),
        BotCommand(command="repair", description="Ремонт оборонительного рубежа"),
